# これは何をするためのもの？
アプリケーションやファイルなどをまとめて実行することができるツールです  
...
> 
>・待機時間を指定した場合は、後続のアプリケーション等の起動も遅れます  
>
> ・アプリケーションの処理内容によっては指定した順序通りに起動しない場合があります  
  
# ツールの使い方
1.&nbsp;追加ボタンを押して、アプリケーションやファイル等を登録します  
...
特記  
SNSなどでスパム行為を繰り返している方と、それらの拡散・支援を行っている方の本ツールの利用を禁止します  
